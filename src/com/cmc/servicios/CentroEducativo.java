...
public class CentroEducativo {
	...
	public void calificar(String codigoMateria, String cedulaAlumno, double calificacion){
	...
	public void listarMaterias(){
		...
		for (int i = 0; i < this.materias.size(); i++) {
			m = this.materias.get(i);
			System.out.println("*** "+m.getCodigo()+" " +m.getNombre()+" ***"+"\nalumnos: max>>"+m.getMaximoAlumnos()
								+" min>>"+m.getMinimoAlumnos()+" Actual: "+m.getNumeroAlumnos());
		}
	}
